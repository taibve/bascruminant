...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        if (empty($_FILES["img_upload"]["name"])) {
            ...
            $target_dir = "dbimg/rabbit/";
            $img_upload = $target_dir . $animalid . ".png";
            $qr_code_path = "qrimg/rabbit/" . $animalid . ".png";
...
<head>
  <meta charset="UTF-8">
  <title>EDIT RABBIT INFORMATION</title>
  <!--style-->
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    ...
    <form action="erabbit.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
