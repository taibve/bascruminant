      ...
      <div class="layout" style="background-color:#e6e6fa;">
        <main class="content">
          <div>
            ...
            <h1 style="margin-bottom: 0; margin-top:25px; color:#444C38; font-size: 30px;font-family: Sans-serif; text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.5); text-align: center;">THIS IS DASHBOARD</h1>
            ...
            <h5 style= "margin-top: 0; text-align: center; font-size: 15px; color:#444C38">
              Good Day! All systems are running smoothly.
            </h5>
            <br />
            <div class="container">
              <a href="medical.php"><div class="cont cont1">
                <div><img class="dIcon" src="dimg/medical.png" height="70px" width="70px"></div>
                    <p>medical record</p>
                </div></a>
            <a href="genealogical.php"><div class="cont cont2">
                 <div><img class="dIcon" src="dimg/genea.png" height="70px" width="70px"></div>
                    <p>genealogical tree</p>
                </div></a>
            <a href="dietchart.php"><div class="cont cont3">
                <div><img class="dIcon" src="dimg/chart.png" height="70px" width="70px"></div>
                    <p>Diet Chart</p>
                </div></a>
          </div>
          <div class="container1">
            <a href="table.php"><div class="cont cont4">
             <div><img class="dIcon" src="dimg/animal.png" height="70px" width="70px"></div>
                <p>Animal Category</p>
            </div>
            </a>
           <a href="user.php"><div class="cont cont5">
              <img class="dIcon" src="dimg/users.png" height="70px" width="70px">
                <p>system users</p>
            </div>
           </a>
        <a href="report.php">
          <div class="cont cont6">
            <div>
              <img class="dIcon" src="dimg/reports.png" height="70px" width="70px">                
              <p>pertinent report</p>
            </div>
          </div>
        </a>
    </div>
