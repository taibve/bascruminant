...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if (empty($idNum) || empty($password) || empty($userType)) {
        ...
        $gmail = mysqli_real_escape_string($connection, $gmail);
        ...
        $sql = "INSERT INTO user_tbl (user_id, id_num, password, user_type, email, status) VALUES (?, ?, ?, ?, ?, ?)";
        $stmt = $connection->prepare($sql);
        $stmt->bind_param("sssssi", $user_id, $idNum, $password_hash, $userType, $gmail, $status);
        $result = $stmt->execute();
        $stmt->close();
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    ...
    <div class="container my 5">
        ...
        <label class="col-sm-3 col-form-label">ID Number</label>
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="id_num" value="<?php echo $idNum ?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-6">
                  <select class="form-select" name="user_type">
                      ...
                      <option value="vetmed">Vet Med</option>
                      <option value="personnel">Personnel</option>
                  </select>
                  <!-- If you want to display the current value, you can use the input element -->
                  <!-- <input type="text" class="form-control" name="user_type" value="<?php echo $userType ?>"> -->
              </div>
          </div>
            <?php
