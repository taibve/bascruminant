...
$sql = "SELECT * FROM animal_tbl WHERE category = 'goat'";
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
      ...
      <div class="layout" style="background-color:#e6e6fa;">
        ...
        <a class="btn btn-primary" href="cgoat.php" role="button"><i class="fa-solid fa-file"></i>&nbsp;New Goat Information</a>
        <div>
            ...
            <?php
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      echo "<tr>";
                      echo "<td><img class='img-goat' src='" . htmlspecialchars($row['image']) . "?v=" . time() . "'></td>";
                      ...
                      echo "<td>";
                      echo "<a class='btn btn-primary btn-sm' href='egoat.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-pen-to-square'></i></a><br>";
                      echo "<a class='btn btn-success btn-sm' href='vgoat.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-eye'></i></a><br>";
