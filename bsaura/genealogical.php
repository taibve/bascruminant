...
<div class="layout has-sidebar fixed-sidebar fixed-header">
          ...
          <div class="sidebar-content">
            <nav class="menu open-current-submenu">
              <ul>
                ...
                <li class="menu-item">
                  <a href="/index.php" onclick="return confirm('Do you want to log out?');">
                    <span class="menu-icon">
      ...
      <div class="col-sm-6 text-center">
        <form action="genealogical.php" method="post">
...
<div class="container">
    <h2>Genealogical Table</h2>
    <a class="btn btn-primary" href="cgenea.php" role="button"><i class="fa-solid fa-file"></i>&nbsp;New Animal Information</a>
    <div>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>" . htmlspecialchars($row['mother_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['father_id']) . "</td>";
                        echo "<td>" . htmlspecialchars($row['category']) . "</td>";
                        echo "<td>";
                        echo "<a class='btn btn-primary btn-sm' href='tree.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-tree'></i></a><br>";
                        echo "</td>";
                        echo "</tr>";
                    }
                } else {
