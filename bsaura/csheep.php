...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    ...
    <div class="container my 5">
        <h2>New Sheep Information</h2>

        <?php
            if (!empty($errorMessage)){
                echo "
                <div class='alert alert-warning alert-dismissable fade show' role='alert' style='text-align:cente;'>
        ...
        <label class="col-sm-3 col-form-label">Animal ID</label>
            ...
            <label class="col-sm-3 col-form-label">Breed</label>
                <div class="col-sm-6">
                    ...
                    <option disabled selected>Choose Sheep Breed</option>
                        <option value="Rambouillet">Rambouillet</option>
                        <option value="Shropsire">Shropsire</option>
                        <option value="American Merino">American Merino</option>
                        <option value="Delaine Merino">Delaine Merino</option>
