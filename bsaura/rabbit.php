...
$sql = "SELECT * FROM animal_tbl WHERE category = 'rabbit'";
      ...
      <div class="layout" style="background-color:#e6e6fa;">
        ...
        <div>
            ...
            <!--- Research for search bar
              ...
              -->
        <div class="container">
        <h2>Rabbit Information</h2>
        <a class="btn btn-primary" href="crabbit.php" role="button"><i class="fa-solid fa-file"></i>&nbsp;New Rabbit Information</a>
        <div>
            ...
            <?php
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      echo "<tr>";
                      echo "<td><img class='img-rabbit' src='" . htmlspecialchars($row['image']) . "?v=" . time() . "'></td>";
                      ...
                      echo "<td>";
                      echo "<a class='btn btn-primary btn-sm' href='erabbit.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-pen-to-square'></i></a><br>";
                      echo "<a class='btn btn-success btn-sm' href='vrabbit.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-eye'></i></a><br>";
