...
$sql = "SELECT * FROM animal_tbl WHERE category = 'carabao'";
      ...
      <div class="layout" style="background-color:#e6e6fa;">
        ...
        <div>
            ...
            <!--- Research for search bar
              ...
              -->
        <div class="container">
        <h2>Carabao Information</h2>
        <a class="btn btn-primary" href="ccarabao.php" role="button"><i class="fa-solid fa-file"></i>&nbsp;New Carabao Information</a>
        <div>
            ...
            <?php
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      echo "<tr>";
                      echo "<td><img class='img-carabao' src='" . htmlspecialchars($row['image']) . "?v=" . time() . "'></td>";
                      ...
                      echo "<td>";
                      echo "<a class='btn btn-primary btn-sm' href='ecarabao.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-pen-to-square'></i></a><br>";
                      echo "<a class='btn btn-success btn-sm' href='vcarabao.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-eye'></i></a><br>";
