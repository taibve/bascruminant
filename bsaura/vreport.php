...
<div class="layout has-sidebar fixed-sidebar fixed-header">
          ...
          <div class="sidebar-content">
            <nav class="menu open-current-submenu">
              <ul>
                ...
                <li class="menu-item">
                  <a href="login.php" onclick="return confirm('Do you want to log out?');">
                    <span class="menu-icon">
    ...
    <div class="div-bottom"> 
        <div style="margin-right: 33.5%; height:250px; width: 800px; ;padding: 10px 40px 10px 40px;">   
        <?php
            echo '<br>';
            echo 'Prepared By:';
            echo '<br>';
        ...
        <div style="margin-right: 5%; margin-left: 35%; height:250px; width: 800px; ;padding: 10px 40px 10px 40px;">   
        <?php
            echo '<br>';
        ...
        <div style="margin-left: 55%; height:250px; width: 800px; ;padding: 10px 40px 10px 40px;">   
        <?php
            echo '<br>';
            echo 'Verified By:';
            echo '<br>';
