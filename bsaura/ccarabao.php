...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    do {
        ...
        $category = 'carabao';
        $sql = "INSERT INTO animal_tbl (animal_id, oldAnimal_id, image,  sex, category,  status, breed, source, qr) " . "VALUES ('$animalid','$oldId','$img_upload','$sex', '$category','$status','$breed','$source','$qr_code_path')";
            ...
            <div class="row mb-3">
             <label class="col-sm-3 col-form-label">Breed</label>
                <div class="col-sm-6">
                    ...
                    <option disabled selected>Choose Carabao Breed</option>
                        <option value="Murrah">Murrah</option>
                        <option value="Nili Ravi">Nili Ravi</option>
                        <option value="Phippine Carabao">Philippine Carabao</option>
                        <option value="Phippine Carabao">Bulgarian</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
