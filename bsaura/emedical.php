...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    if (!isset($_GET["id"])) {
        ...
        $id = $_GET["id"];
        $sql = "SELECT * FROM medical_tbl WHERE animal_id = ?";
    ...
    do {
        ...
        // Update the record
        $sql = "UPDATE medical_tbl SET animal_id = ?, deworming = ?, vitamins = ?, schedule = ?, animal_type = ? WHERE animal_id = ?";
        $stmt = $connection->prepare($sql);
        $stmt->bind_param("ssssss", $animalId, $deworming, $vitamins, $schedule, $animalType, $id);
        $result = $stmt->execute();
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    ...
    <h2><?php echo "Edit $animalType Medical Information" ?></h2>
    ...
    <form action="emedical.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="date" class="form-control" name="deworming" value="<?php echo $deworming; ?>">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">Vitamins</label>
            <div class="col-sm-6">
                <input type="date" class="form-control" name="vitamins" value="<?php echo $vitamins; ?>">
            </div>
        </div>
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">Assigned Students</label>
            <div class="col-sm-6">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="animal_type" value="<?php echo $animalType; ?>">
            </div>
        </div>
        <?php
