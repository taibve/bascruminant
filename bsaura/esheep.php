...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        if (empty($_FILES["img_upload"]["name"])) {
            ...
            $target_dir = "dbimg/sheep/";
            $img_upload = $target_dir . $animalid . ".png";
            $qr_code_path = "qrimg/sheep/" . $animalid . ".png";
...
<head>
  <meta charset="UTF-8">
  <title>EDIT SHEEP INFORMATION</title>
  <!--style-->
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    ...
    <form action="esheep.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                ...
                <script>
                    document.getElementById("cancelButton").addEventListener("click", function () {
                        ...
                        if (confirmCancel) {
                            ...
                            window.location.href = "sheep.php";
                        }
                    });
