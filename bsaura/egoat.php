...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    do {
        ...
        if (empty($_FILES["img_upload"]["name"])) {
            ...
            $target_dir = "dbimg/goat/";
            $img_upload = $target_dir . $animalid . ".png";
            $qr_code_path = "qrimg/goat/" . $animalid . ".png";
...
<head>
  <meta charset="UTF-8">
  <title>EDIT GOAT INFORMATION</title>
  <!--style-->
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
    ...
    <form action="egoat.php?id=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
