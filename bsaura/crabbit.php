        ...
        <label class="col-sm-3 col-form-label">Animal ID</label>
            ...
            <label class="col-sm-3 col-form-label">Breed</label>
                <div class="col-sm-6">
                    ...
                    <option disabled selected>Choose Rabbit Breed</option>
                        <option value="Dutch Whites">Dutch Whites</option>
                        <option value="Californians">Californians</option>
                        <option value="Sables">Sables</option>
                        <option value="New Zealand">New Zealand</option>
                        <option value="Angoras">Angoras</option>
