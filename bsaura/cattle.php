...
$sql = "SELECT * FROM animal_tbl WHERE category = 'cattle'";
...
<div class="layout has-sidebar fixed-sidebar fixed-header">
      ...
      <div class="layout" style="background-color:#e6e6fa;">
        ...
        <a class="btn btn-primary" href="ccattle.php" role="button"><i class="fa-solid fa-file"></i>&nbsp;New Cattle Information</a>
        <div>
            ...
            <?php
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      echo "<tr>";
                      echo "<td><img class='img-cattle' src='" . htmlspecialchars($row['image']) . "?v=" . time() . "'></td>";
                      ...
                      echo "<td>";
                      echo "<a class='btn btn-primary btn-sm' href='ecattle.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-pen-to-square'></i></a><br>";
                      echo "<a class='btn btn-success btn-sm' href='vcattle.php?id=" . htmlspecialchars($row['animal_id']) . "'><i class='fa-solid fa-eye'></i></a><br>";
